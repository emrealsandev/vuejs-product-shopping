            ...
            <div class="col-12 mb-5 card mt-5 shadow">
                <div class="card-body">
                    ...
                    <div class="alert alert-warning" v-else>
                        ...
                        <br>
                        <small>Kayıt Eklemek için <router-link tag="a" class="text-danger" to="/urun-islemleri"><a class="text-danger">Ürün İşlemleri</a></router-link>  menüsünden yararlanabilirsiniz
                        </small>
                    </div>
                </div>
            </div>
